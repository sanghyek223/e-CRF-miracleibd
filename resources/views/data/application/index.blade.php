                    ...
                    <fieldset>
                        ...
                        <div class="table-wrap">
                            <table class="cst-table">
                                ...
                                @if($search_params['created_at']['created_at_s'] || $search_params['created_at']['created_at_e'])
                                    <tr>
                                        <th scope="row">{{ $dataConfig['search_params']['created_at'] }}</th>
                                        <td colspan="3" class="text-left ESS-CHK">
                                            @if($search_params['created_at']['created_at_s'])
                                                {{ $search_params['created_at']['created_at_s'] }}
                                            @endif

                                            @if($search_params['created_at']['created_at_e'])
                                                ~ {{ $search_params['created_at']['created_at_e'] }}
                                            @endif
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if($search_params['IBD_age']['IBD_age_s'] || $search_params['IBD_age']['IBD_age_e'])
                                    <tr>
                                        <th scope="row">{{ $dataConfig['search_params']['IBD_age'] }}</th>
                                        <td colspan="3" class="text-left ESS-CHK">
                                            @if($search_params['IBD_age']['IBD_age_s'])
                                                {{ $search_params['IBD_age']['IBD_age_s'] }}
                                            @endif

                                            @if($search_params['IBD_age']['IBD_age_e'])
                                                ~ {{ $search_params['IBD_age']['IBD_age_e'] }}
                                            @endif
                                        </td>
                                    </tr>
                                @endif
                            ...
                            <table class="cst-table" id="FASTQ-tbl">
                                ...
                                @forelse($patientsFASTQ as $row)
                                    <tr>
                                        ...
                                        <td>{{ formatBytes($row->FASTQ->getFileSizeAll()) }}</td>
                                    </tr>
                                @empty
                                    <tr>
...
@section('addScript')
    <script>
        ...
        // FASTQ ALL DATA
        $(document).on('change', `${form} #FASTQ_all`, function () {
        ...
        // FASTQ 개별 선택
        $(document).on('change', `${form} #FASTQ-tbl .fastq-chk`, function () {
        ...
        $(document).on('change', `${form} #backup1_all`, function () {
            const checked = $(this).is(':checked');
        ...
        // Baseline
        $(document).on('change', `${form} #backup1-tbl #backup1_BASE`, function () {
            const checked = $(this).is(':checked');
        ...
        $(document).on('change', `${form} #backup1-tbl .backup1-BASE`, function () {
        ...
        $(document).on('change', `${form} #backup1-tbl #backup1_END`, function () {
            const checked = $(this).is(':checked');
        ...
        $(document).on('change', `${form} #backup1-tbl .backup1-END`, function () {
        ...
        $(document).on('change', `${form} #backup2_all`, function () {
            const checked = $(this).is(':checked');
        ...
        // Follow-up
        $(document).on('change', `${form} #backup2-tbl #backup2_FU`, function () {
            const checked = $(this).is(':checked');
        ...
        $(document).on('change', `${form} #backup2-tbl .backup2-FU`, function () {
